...
python -u main_2.py --work-dir june19_5 --gpus 1 --cpus 1 --dataset_index 6 --testset_index 0 --start_batch_size 1024 --max_local_epoch_count 10 --test_size 0.2 --train_size 0.8 --ani_lib gpu_featurizer/ani_small_new.so
